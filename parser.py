...
cfg = {
    ...
    21: "MatchedStmt → id = Expr ;",
    22: "MatchedStmt → type id ;",
    23: "MatchedStmt → type id = Expr ;",
    24: "MatchedStmt → Block",
    25: "UnmatchedStmt → if ( Expr ) Stmt",
    26: "UnmatchedStmt → if ( Expr ) MatchedStmt else UnmatchedStmt",
    27: "Expr → EqualityExpr",
    28: "EqualityExpr → EqualityExpr == AddExpr",
    29: "EqualityExpr → AddExpr",
    30: "AddExpr → AddExpr + MulExpr",
    31: "AddExpr → MulExpr",
    32: "MulExpr → MulExpr * UnaryExpr",
    33: "MulExpr → UnaryExpr",
    34: "UnaryExpr → - UnaryExpr",
    35: "UnaryExpr → id ( ArgList )",
    36: "UnaryExpr → id",
    37: "UnaryExpr → num",
    38: "UnaryExpr → ( Expr )",
    39: "ArgList → Expr , ArgList",
    40: "ArgList → Expr",
    41: "ArgList → ε"
}
