...
cfg = {
    ...
    18: "Stmt → ReturnStmt",
    19: "Stmt → ExprStmt",
    20: "Stmt → VarDecl",   # 새로 추가된 CFG 문법
    21: "Stmt → Block",
    22: "MatchedStmt → if ( Expr ) MatchedStmt else MatchedStmt",
    23: "UnmatchedStmt → if ( Expr ) Stmt",
    24: "UnmatchedStmt → if ( Expr ) MatchedStmt else UnmatchedStmt",
    25: "LoopStmt → while ( Expr ) Stmt",
    26: "LoopStmt → for ( Expr ; Expr ; Expr ) Stmt",
    27: "ReturnStmt → return Expr ;",
    28: "ExprStmt → id = Expr ;",  # 수정된 CFG 문법 
    29: "Expr → EqualityExpr",
    30: "EqualityExpr → EqualityExpr == AddExpr",
    31: "EqualityExpr → AddExpr",
    32: "AddExpr → AddExpr + MulExpr",
    33: "AddExpr → MulExpr",
    34: "MulExpr → MulExpr * UnaryExpr",
    35: "MulExpr → UnaryExpr",
    36: "UnaryExpr → - UnaryExpr",
    37: "UnaryExpr → id ( ArgList )",
    38: "UnaryExpr → id",
    39: "UnaryExpr → num",
    40: "UnaryExpr → ( Expr )",
    41: "ArgList → Expr , ArgList",
    42: "ArgList → Expr",
    43: "ArgList → ε"
}
